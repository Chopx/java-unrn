...
public class UI_Ventas extends JFrame {
	 ...
	 * Create the frame.
	 */
	public UI_Ventas(RepositorioDeFacturas repo) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				UI_ListadoVentas vistaListadoVentas = new UI_ListadoVentas(repo, inicio, fin);
